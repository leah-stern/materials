...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ['CHEMICAL_DATABASE_URL']
app.config['SQLALCHEMY_BINDS'] = {'formulations':os.environ['FORMULATION_DATABASE_URL']}
db = SQLAlchemy(app)
